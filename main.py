...
import os
import carla
os.environ['DGDRL_ROOT'] = '/home/block/IJCAI/'
...
def main():
    ...
    experiment_path = f'{os.getenv("HOME")}/results/dgdrl/{experiment_name}'
    ...
    DGDRL_ROOT = os.getenv('DGDRL_ROOT')
    observation_config_path = f"{DGDRL_ROOT}/config/experiments/{experiment_name}/observation.yaml"
    agent_config_path = f"{DGDRL_ROOT}/config/experiments/{experiment_name}/agent.yaml"
    train_test_config_path = f"{DGDRL_ROOT}/config/experiments/{experiment_name}/{train_test_config_name}"
    ...
    env_config_path = f"{DGDRL_ROOT}/config/envs/{env_config_name}"
    ...
    diff_log=open('/home/block/IJCAI/agents/models/diffusion/diffusion_result.txt', 'a')    
    for ep in range(n_episodes):
        ...
        while not done:
            ...
            #metrics.pop('diffusion_loss', None)
            #metrics.pop('diffusion_h', None)
            #metrics.pop('diffusion_h_hat', None)
